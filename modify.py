...
# 如果脚本就放在该目录下，可以用 "."
source_dir = r"/home/wyj24/project/video_generation/output/Wan2.1-T2V-1.3B-Diffusers_steps15_fps16_samples5_res832x480/overall_consistency" 

# 输出目录：你想把提取出来的视频存放在哪里
output_dir = r"/home/wyj24/project/video_generation/output/Wan2.1-T2V-1.3B-Diffusers_steps15_fps16_samples5_res832x480/overall_consistency_2"
# ===========================================
