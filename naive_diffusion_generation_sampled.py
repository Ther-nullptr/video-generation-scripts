...
def parse_args():
    parser = argparse.ArgumentParser(description="VBench Video Generation Script (Sampled)")
...
def main():
    ...
    for dimension in args.dimensions:
        ...
        print(f"  Sampled {sampled_count}/{original_count} prompts ({args.sample_ratio*100:.1f}%)")
